 ...
 */
    ...
    I have a new vision regarding flows (and swarms):
        - see them as Petri nets
        - reason about them mathematically
        - make them easier to prove stuff on
        To do:
            - convince Sanica not to allow calling another state from the current state
            - use only this.next and async calls
            - run joins immediately
     */
...
flow.prototype.next = function() {
    ...
    if(motivation === undefined){
        motivation = self.currentPhase+" to "+stateName;
    }
...
flow.prototype.continue = function(){
    ...
    var self = this;
    if(motivation === undefined){
        motivation = this.currentPhase+" to "+stateName;
    }
        ...
        function makePhaseUpdates(func,stateName){
            return function() {
                ...
                function motivateCall(){
                    return self.currentPhase+ " to "+ stateName;
                }
