...
exports.create = function(flowName,states){
    ...
    function createStatesGraph() {
        ...
        function attachFunctionForDirectCall(functionName,code){
            thisFlow[functionName] = function(){
                var args = [];
                for(var arg in arguments){
                    args.push(arguments[arg]);
                }
                statesRegister[functionName].joins.forEach(function(join){
                    joinsRegister[join].inputStates[functionName]++;
                })
